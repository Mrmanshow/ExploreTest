using Explore.Core.ComponentModel;
...
namespace Explore.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        public static void Initialize()
        {
            ...
            {
                // TODO:在此处添加详细的异常处理/引发，因为这是在应用程序启动时发生的，可能会阻止应用程序完全启动。
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(ExploreVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
